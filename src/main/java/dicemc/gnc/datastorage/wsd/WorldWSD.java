...
public class WorldWSD extends WorldSavedData{
	...
	private Map<UUID, Guild> GUILDS = new HashMap<UUID, Guild>();
	...
	public void read(CompoundNBT nbt) {
		...
		for (int i = 0; i < list.size(); i++) {GUILDS.put(list.getCompound(i).getUniqueId("ID"), new Guild(list.getCompound(i).getCompound("guild"))); }
